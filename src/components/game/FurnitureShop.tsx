...
import { PlayerStats, BiomeType } from '@/types/game';
...
interface FurnitureShopProps {
  ...
  onClose: () => void;
  stats: PlayerStats;
  onPurchase: (item: FurnitureItem) => boolean;
  ownedItems: string[];
}
...
export function FurnitureShop({ isOpen, onClose, stats, onPurchase, ownedItems }: FurnitureShopProps) {
